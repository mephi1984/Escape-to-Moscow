...
style bar:
    ysize gui.bar_size
    left_bar Frame(gui.bar_left, gui.bar_borders, tile=gui.bar_tile)
    right_bar Frame(gui.bar_right, gui.bar_borders, tile=gui.bar_tile)

style vbar:
    xsize gui.bar_size
    top_bar Frame(gui.bar_top, gui.vbar_borders, tile=gui.bar_tile)
    bottom_bar Frame(gui.bar_bottom, gui.vbar_borders, tile=gui.bar_tile)
...
style frame:
    ...
    background Frame(gui.frame, gui.frame_borders, tile=gui.frame_tile)
...
style window:
    ...
    background Image(gui.textbox, xalign=0.5, yalign=1.0)
...
style namebox:
    ...
    background Frame(gui.namebox, gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
...
style main_menu_vbox_logo is vbox
...
style main_menu_frame:
    ...
    background  gui.main_menu_overlay
...
style main_menu_vbox_logo:
    xalign 0.0
    xoffset int(SCALE*30)
    xmaximum int(SCALE*1200)
    yalign 0.0
    yoffset int(SCALE*30)
...
style game_menu_outer_frame:
    bottom_padding int(SCALE*45)
    top_padding int(SCALE*180)
...
style game_menu_content_frame:
    left_margin int(SCALE*60)
    right_margin int(SCALE*30)
    top_margin int(SCALE*15)

style game_menu_viewport:
    xsize int(SCALE*1380)

style game_menu_vscrollbar:
    unscrollable gui.unscrollable

style game_menu_side:
    spacing int(SCALE*15)
...
style page_label:
    xpadding int(SCALE*75)
    ypadding int(SCALE*6)
...
style confirm_frame:
    background Frame(gui.frame, gui.confirm_frame_borders, tile=gui.frame_tile)
...
#define show_skip_indicator = True
...
style skip_frame:
    ypos gui.skip_ypos
    background Frame(gui.skip, gui.skip_frame_borders, tile=gui.frame_tile)
...
style notify_frame:
    ...
    background Frame(gui.notify, gui.notify_frame_borders, tile=gui.frame_tile)
