label day4_parents_part6_parent_persuade_success:
    ...
    me "У них есть проблемы с багажом да и сотрудники далеко не вежливые," with dissolve

    me "плюс комиссия два процента при оплате картой, что тоже не особо выгодно." with dissolve
    ...
    me "Билеты куплены. В аэропорту Вам всего лишь потребуется найти стойки регистрации от 104 до 136." with dissolve

    me "Их легко узнать: они зелёного цвета." with dissolve
    ...
    me "Конечно, я был бы рад, если всё сказанное твоей семьёй оказалось правдой." with dissolve

    me "Это, говоря на чистоту, было бы отлично, при этом..." with dissolve
...
label day4_parents_part13:
    ...
    if debug_mode == True:
        menu:
            ...
            "Семён смог уговорить Алию.":
                jump day4_imran_house_new_escape_succeed

            "Семён не смог уговорить Алию.":
