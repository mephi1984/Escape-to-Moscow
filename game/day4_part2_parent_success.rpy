...
label day4_parents_part11_choice1_persuade:
    ...
    me "Если продолжишь идти в том же темпе, я просто уверен, не пройдет и 10-ти лет как я смогу прийти в небольшое кафе, где вкусные бисквиты будет готовить очаровательна девушка по имени Алия." with dissolve
