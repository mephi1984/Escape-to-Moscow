label day4_imran_house_new_escape_succeed:
    ...
    "Я остался наедине со своими мыслями, сэндвичем и чаем..." with dissolve
    ...
    "Я знаю Алию только четыре дня и за это время мы сбежали из Пятигорска, чтобы так глупо угодить в ловушку." with dissolve
    ...
    "Конечно, сначала придётся туговато, но без денег уж точно не останусь — я же фрилансер и могу работать где угодно." with dissolve
...
label airport_scene1:
    ...
    "Вскоре загорелся зелёный свет, Алия подошла к будке и протянула свои документы." with dissolve
